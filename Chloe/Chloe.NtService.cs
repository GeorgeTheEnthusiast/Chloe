...
namespace Chloe
{
    partial class ChloeNtService : ServiceBase
    {
        private Logger _logger = LogManager.GetCurrentClassLogger();

        public ChloeNtService()
        {
            InitializeComponent();
        }
        ...
        public void StartQuartzJob()
        {
            ...
            //QuartzJobFactory.ScheduleJob<SearchChloeJob>(CronScheduleBuilder.DailyAtHourAndMinute(15, 00));
            //QuartzJobFactory.ScheduleJob<ChloeNetJob>(SimpleScheduleBuilder.Create());
            //QuartzJobFactory.ScheduleJob<ChloeNetJob>(CronScheduleBuilder.WeeklyOnDayAndHourAndMinute(DayOfWeek.Monday, 15, 00));
