...
namespace Chloe.Client
{
    public partial class GroupsForm : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'ChloeDataSet.NotificationReceivers' table. You can move, or remove it, as needed.
            this.notificationReceiversTableAdapter.Fill(this.ChloeDataSet.NotificationReceivers);
            // TODO: This line of code loads data into the 'ChloeDataSet.ReceiverGroups' table. You can move, or remove it, as needed.
        ...
        {
            using (var entities = new ChloeEntities1())
            {
        ...
        private void buttonAddEmailToGroup_Click(object sender, EventArgs e)
        {
            ...
            using (var flightEntities = new ChloeEntities1())
            {
                bool exist =
        ...
        private ChloeDataSet.NotificationReceiversRow ReturnCurrentSelectedNotificationReceiversRow()
        {
            var dataRowView = dataGridViewReceivers.SelectedRows[0].DataBoundItem as DataRowView;
            return dataRowView.Row as ChloeDataSet.NotificationReceiversRow;
        }

        private ChloeDataSet.ReceiverGroupsRow ReturnCurrentSelectedReceiverGroupsRow()
        {
            var dataRowView = (dataGridViewGroups.SelectedRows[0].DataBoundItem as DataRowView);
            return dataRowView.Row as ChloeDataSet.ReceiverGroupsRow;
        }

        private ChloeDataSet.ReceiverGroupsRow ReturnCurrentSelectedJoinedRow()
        {
